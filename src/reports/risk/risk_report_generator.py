...
class RiskReportGenerator:
    ...
    def __init__(self, output_dir: Optional[Union[str, Path]] = None):
        ...
        if output_dir:
            ...
            self.output_dir = config.get_reports_dir("risk")
    ...
    def generate_report(self,
        ...
        logger.info(f"Flood risk report generated: {output_path}")
        logger.info(f"Pages: {len(pages_to_include)} | Elements: {len(elements)}")
