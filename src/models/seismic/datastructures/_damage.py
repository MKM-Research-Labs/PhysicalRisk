...
class AssetSeismicResult:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "no_collapse_rate": self.no_collapse_rate,
            "seismic_spread_bps": self.seismic_spread_bps,
            "mean_resilience_index": self.mean_resilience_index,
            "pml_475": self.pml_475,
            "pml_2475": self.pml_2475,
        }
