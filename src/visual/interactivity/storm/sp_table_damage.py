...
def get_js() -> str:
    ...
    return """
            // ================================================================
            // Flood Damage — combined residential + commercial rows
            // ================================================================
            //
            // Row shape (uniform across both asset classes):
            //   { asset_id, asset_class, address, type, value,
            //     damage_amount, damage_ratio,
            //     // mortgage/loan fields kept on the row so the
            //     // Mortgage and Summary tabs can reuse the cache:
            //     outstanding_balance, current_ltv, post_damage_ltv,
            //     remaining_term_months, negative_equity }
            // ================================================================
