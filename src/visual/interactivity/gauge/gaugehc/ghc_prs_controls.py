...
"""
Gauge hazard curve — PRS Pricing: controls and maturity popup.

Input form (direction, counterparty, trigger, notional, tenor, spread)
and maturity schedule info popup.
"""


def get_js() -> str:
    """Return JS fragment for PRS controls and maturity popup."""
    return """
            // ================================================================
            // PRS Controls (input form for Tab 3)
            // ================================================================
            function buildPRSControls() {
                ...
                controls.innerHTML =
                    ...
                    'style="padding:2px 7px;font-size:10px;border:1px solid #ccc;border-radius:3px;background:#f0f4f8;cursor:pointer;color:#1565c0;font-weight:bold;" ' +
                    ...
                    '<span id="prs-hazard-display" style="font-size:10px;color:#888;"></span>' +
                    '</div>';
            ...
            window.showMaturityPopup = function() {
                ...
                popup.style.cssText = 'position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);' +
                    'background:white;border:1px solid #ccc;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,0.2);' +
                ...
                var html = '<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">' +
                    ...
                    'style="border:none;background:none;font-size:18px;cursor:pointer;color:#666;">&times;</button></div>' +
                    '<div style="font-size:10px;color:#888;margin-bottom:8px;">Roll: ' + rollLabel + '</div>' +
                    '<table style="width:100%;border-collapse:collapse;">' +
                    '<tr style="border-bottom:2px solid #ddd;"><th style="text-align:left;padding:4px 8px;">Tenor</th>' +
