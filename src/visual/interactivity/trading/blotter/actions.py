...
"""
Trade Blotter — trade action sub-module.

Trade view (PRS pricing click-through), close-out modal, and contract PDF viewer.
"""


def get_js() -> str:
    """Return JavaScript fragment for blotter trade actions."""
    return """
            // Navigate to PRS pricing screen for trade REVIEW (all inputs locked)
