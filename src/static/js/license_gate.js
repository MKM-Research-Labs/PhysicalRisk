...
// Licence-acceptance gate shown on first load, before any data is fetched.
//
// _showLicenseGate(onAccept, onCancel) builds a modal overlay carrying the MKM
// copyright/licence text with Accept / Cancel buttons. Accept runs onAccept
// (the startup data preloader — the "download"); Cancel runs onCancel, which
// aborts onboarding. Concatenated into the startup IIFE (see startup.py), so it
// shares scope with _runStartupPreload.
