...
# src/utilities/flood_risk_base_page.py
...
class FloodRiskBasePage(ABC):
    ...
    def _setup_styles(self):
        """Set up paragraph styles for the flood risk report."""
    ...
    def _setup_table_styles(self):
        """Set up table styles for different flood risk content types."""
        self.table_styles = {
            'standard': TableStyle([
