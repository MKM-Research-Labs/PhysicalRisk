...
class GaugeBasePage(ABC):
    ...
    def _setup_styles(self):
        """Set up paragraph styles for the gauge report."""
    ...
    def _setup_table_styles(self):
        """Set up table styles for different gauge content types."""
        self.table_styles = {
            'standard': TableStyle([
    ...
    def _setup_dimensions(self):
        ...
        # Table width configurations (optimized for gauge data)
        self.table_widths = {
            'two_col': [3 * inch, 4.5 * inch],
            'three_col': [2.5 * inch, 3 * inch, 2 * inch],
            'four_col': [1.8 * inch, 2 * inch, 1.8 * inch, 1.9 * inch],
            'gauge_table': [2.8 * inch, 2.8 * inch, 1.4 * inch, 0.9 * inch]
        }
    ...
    def _format_field_name(self, field_name: str) -> str:
        ...
        # Handle specific gauge abbreviations
        replacements = {
