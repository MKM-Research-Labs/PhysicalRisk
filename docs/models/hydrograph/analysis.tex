...
\fancyhead[R]{\small\textcolor{mkmgrey}{Hydrograph Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Hydrograph Model}}\\[4pt]
{\normalsize MKM-HG-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Hydrograph Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Hydrograph Model.}
    \begin{tabular}{lll}
        \toprule
