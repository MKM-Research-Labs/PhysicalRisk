...
\fancyhead[R]{\small\textcolor{mkmgrey}{Storm Sequence Generator --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Storm Sequence Generator}}\\[4pt]
{\normalsize MKM-SS-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Storm Sequence Generator.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Storm Sequence Generator.}
    \begin{tabular}{lll}
        \toprule
