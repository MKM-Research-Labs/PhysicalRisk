...
| | |
|---|---|
| **Status** | **Signed off** — baseline rev. 3 (2026-06-03, Risk); **v4.0 records Stage 2 + Stage 3 + Stage 4 + Stage 5 as implemented** (2026-06-03). |
| **Version** | 4.0 |
| **Date** | 2026-06-03 |
