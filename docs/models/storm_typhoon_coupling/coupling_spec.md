...
| | |
|---|---|
| **Status** | **Signed off** — baseline rev. 3 (2026-06-03, Risk); **v3.0 records Stage 2 + Stage 3 + Stage 4 as implemented** (2026-06-03). |
| **Version** | 3.0 |
| **Date** | 2026-06-03 |
...
5. **Wind into pricing** — define `is_prs_wind`; union trigger in `pricing.py::_process_property`; flood-only fallback.
