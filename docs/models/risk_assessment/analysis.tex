...
\fancyhead[R]{\small\textcolor{mkmgrey}{Risk Assessment Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Risk Assessment Model}}\\[4pt]
{\normalsize MKM-RA-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Risk Assessment Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Risk Assessment Model.}
    \begin{tabular}{lll}
        \toprule
