...
\fancyhead[R]{\small\textcolor{mkmgrey}{Property Valuation Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Property Valuation Model}}\\[4pt]
{\normalsize MKM-PV-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Property Valuation Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Property Valuation Model.}
    \begin{tabular}{lll}
        \toprule
