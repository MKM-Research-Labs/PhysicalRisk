...
\fancyhead[R]{\small\textcolor{mkmgrey}{Storm Intensity Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Storm Intensity Model}}\\[4pt]
{\normalsize MKM-SI-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Storm Intensity Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Storm Intensity Model.}
    \begin{tabular}{lll}
        \toprule
