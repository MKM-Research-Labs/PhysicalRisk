...
\fancyhead[R]{\small\textcolor{mkmgrey}{BRI-Adjusted Floor Level Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{BRI-Adjusted Floor Level Model}}\\[4pt]
{\normalsize MKM-BRF-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for BRI-Adjusted Floor Level Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for BRI-Adjusted Floor Level Model.}
    \begin{tabular}{lll}
        \toprule
