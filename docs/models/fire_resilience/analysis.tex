...
\fancyhead[R]{\small\textcolor{mkmgrey}{Building Fire-Resilience Credit Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Building Fire-Resilience Credit Model}}\\[4pt]
{\normalsize MKM-FIRE-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Building Fire-Resilience Credit Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Building Fire-Resilience Credit Model.}
    \begin{tabular}{lll}
        \toprule
