...
\fancyhead[R]{\small\textcolor{mkmgrey}{Spatial Interpolation Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Spatial Interpolation Model}}\\[4pt]
{\normalsize MKM-SP-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Spatial Interpolation Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Spatial Interpolation Model.}
    \begin{tabular}{lll}
        \toprule
