...
\fancyhead[R]{\small\textcolor{mkmgrey}{Wind Damage Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Wind Damage Model}}\\[4pt]
{\normalsize MKM-WD-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Wind Damage Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Wind Damage Model.}
    \begin{tabular}{lll}
        \toprule
