...
\fancyhead[R]{\small\textcolor{mkmgrey}{Insurance Premium Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Insurance Premium Model}}\\[4pt]
{\normalsize MKM-IP-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Insurance Premium Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Insurance Premium Model.}
    \begin{tabular}{lll}
        \toprule
