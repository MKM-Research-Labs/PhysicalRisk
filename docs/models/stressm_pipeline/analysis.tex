...
\fancyhead[R]{\small\textcolor{mkmgrey}{Stress Test Pipeline --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Stress Test Pipeline}}\\[4pt]
{\normalsize MKM-ST-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Stress Test Pipeline.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Stress Test Pipeline.}
    \begin{tabular}{lll}
        \toprule
