...
\fancyhead[R]{\small\textcolor{mkmgrey}{Building Seismic-Resilience Credit Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Building Seismic-Resilience Credit Model}}\\[4pt]
{\normalsize MKM-SEIS-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Building Seismic-Resilience Credit Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Building Seismic-Resilience Credit Model.}
    \begin{tabular}{lll}
        \toprule
