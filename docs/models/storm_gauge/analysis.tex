...
\fancyhead[R]{\small\textcolor{mkmgrey}{Storm-Gauge Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Storm-Gauge Model}}\\[4pt]
{\normalsize MKM-SG-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Storm-Gauge Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Storm-Gauge Model.}
    \begin{tabular}{lll}
        \toprule
