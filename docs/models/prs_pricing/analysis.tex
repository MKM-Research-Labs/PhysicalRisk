...
\fancyhead[R]{\small\textcolor{mkmgrey}{PRS Analytical Pricing Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{PRS Analytical Pricing Model}}\\[4pt]
{\normalsize MKM-PR-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for PRS Analytical Pricing Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for PRS Analytical Pricing Model.}
    \begin{tabular}{lll}
        \toprule
