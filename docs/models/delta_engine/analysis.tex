...
\fancyhead[R]{\small\textcolor{mkmgrey}{Delta Engine --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Delta Engine}}\\[4pt]
{\normalsize MKM-DE-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Delta Engine.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Delta Engine.}
    \begin{tabular}{lll}
        \toprule
