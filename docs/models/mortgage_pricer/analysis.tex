...
\fancyhead[R]{\small\textcolor{mkmgrey}{Mortgage Pricer Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Mortgage Pricer Model}}\\[4pt]
{\normalsize MKM-MP-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Mortgage Pricer Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Mortgage Pricer Model.}
    \begin{tabular}{lll}
        \toprule
