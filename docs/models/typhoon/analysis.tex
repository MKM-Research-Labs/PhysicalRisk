...
\fancyhead[R]{\small\textcolor{mkmgrey}{Tropical Cyclone Progression and Wind-Field --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Tropical Cyclone Progression and Wind-Field}}\\[4pt]
{\normalsize MKM-TC-001}\\[12pt]
{\small Report Date: 21 July 2026}\\[4pt]
...
\textit{Sensitivity analysis tables have not yet been generated for this model.
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Tropical Cyclone Progression and Wind-Field.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Tropical Cyclone Progression and Wind-Field.}
    \begin{tabular}{lll}
        \toprule
