...
\fancyhead[R]{\small\textcolor{mkmgrey}{Flood Classifier Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Flood Classifier Model}}\\[4pt]
{\normalsize MKM-FC-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Flood Classifier Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Flood Classifier Model.}
    \begin{tabular}{lll}
        \toprule
