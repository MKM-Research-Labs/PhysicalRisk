...
\fancyhead[R]{\small\textcolor{mkmgrey}{GEV Hazard Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{GEV Hazard Model}}\\[4pt]
{\normalsize MKM-GH-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for GEV Hazard Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for GEV Hazard Model.}
    \begin{tabular}{lll}
        \toprule
