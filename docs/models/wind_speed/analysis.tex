...
\fancyhead[R]{\small\textcolor{mkmgrey}{Event Wind Lookup --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Event Wind Lookup}}\\[4pt]
{\normalsize MKM-WS-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Event Wind Lookup.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Event Wind Lookup.}
    \begin{tabular}{lll}
        \toprule
