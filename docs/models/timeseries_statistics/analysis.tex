...
\fancyhead[R]{\small\textcolor{mkmgrey}{Timeseries Statistics Model --- Analysis --- v1.0}}
...
{\large\textcolor{mkmblue}{Timeseries Statistics Model}}\\[4pt]
{\normalsize MKM-TS-001}\\[12pt]
...
\begin{table}[H]
    \centering
    \caption{Stress testing scenarios for Timeseries Statistics Model.}
    \begin{tabular}{llll}
        \toprule
...
\begin{table}[H]
    \centering
    \caption{Performance metrics for Timeseries Statistics Model.}
    \begin{tabular}{lll}
        \toprule
