...
"""Tests for routes/propertyts/core.py — storm enrichment: parsing, metadata, severity."""
...
class TestFloodStormsEnrichmentStorms:
    """Storm enrichment paths: empty storm_id, read errors, metadata, severity."""
