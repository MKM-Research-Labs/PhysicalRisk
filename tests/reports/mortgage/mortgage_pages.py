...
"""
Tests for reports.mortgage — MortgageTitlePage and MortgageReportGenerator.

Covers: generate_elements (full data, empty data, no mortgage_data),
MortgageReportGenerator.__init__, _generate_filename, _generate_elements,
and generate_mortgage_report convenience function.
"""
...
class TestMortgageTitlePage:

    def test_returns_list(self, sample_property_data, sample_mortgage_data):
        from reports.mortgage.mortgage_page_01_title import MortgageTitlePage
        page = MortgageTitlePage()
...
# ===========================================================================
# MortgageReportGenerator
# ===========================================================================

class TestMortgageReportGenerator:

    def test_init_creates_output_dir(self, tmp_path):
        from reports.mortgage.mortgage_generator import MortgageReportGenerator
        output_dir = tmp_path / "reports"
        gen = MortgageReportGenerator(output_dir=output_dir)
...
# ===========================================================================
# generate_mortgage_report convenience function
# ===========================================================================
...
class TestGenerateMortgageReport:
    ...
    def test_convenience_function_creates_pdf(self, tmp_path,
                                               sample_property_data, sample_mortgage_data):
        from reports.mortgage.mortgage_generator import generate_mortgage_report
        output = generate_mortgage_report(
            sample_property_data, sample_mortgage_data,
            output_dir=tmp_path
        )
        assert output.exists()
    ...
    def test_convenience_function_returns_path(self, tmp_path,
        ...
        from reports.mortgage.mortgage_generator import generate_mortgage_report
        from pathlib import Path
        result = generate_mortgage_report(
            sample_property_data, sample_mortgage_data,
            output_dir=tmp_path
        )
        assert isinstance(result, Path)
