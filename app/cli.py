...
"""
CLI argument parser and subcommand registration.
"""

import argparse
from app.commands import server, port, visual, test, check, config, book, classifier
...
def build_parser():
    ...
    classifier.register_parser(subparsers)
